...
<head>
  ...
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/adminassets/css/style-starter.css">
...
<section>
  ...
  <div class="sidebar-menu sticky-sidebar-menu">
    ...
    <div class="logo-icon text-center">
      <a href="index.html" title="logo"><img src="<?php echo base_url(); ?>assets/adminassets/images/logo.png" alt="logo-icon"> </a>
    </div>
    <!-- //logo end -->
    ...
    <div class="sidebar-menu-inner">
      ...
      <ul class="nav nav-pills nav-stacked custom-nav">
        ...
        <li class="menu-list">
          ...
          <ul class="sub-menu-list">
            <li><a href="addnewuser">Add</a> </li>
            <li><a href="listallusers">All Users</a> </li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo base_url(); ?>assets/adminassets/images/avatar1.jpg" alt=""></div>
                  ...
                  <li class="odd"><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo base_url(); ?>assets/adminassets/images/avatar2.jpg" alt=""></div>
                      <div class="notification_desc">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="<?php echo base_url(); ?>assets/adminassets/images/avatar3.jpg" alt=""></div>
                      <div class="notification_desc">
